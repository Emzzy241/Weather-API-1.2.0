...
* 6. Ensure you take part in the no5 otherwise you'll get a "401: invalid api key" error. If you do get lost on the way, you can contact me with the contact details I supplied below
...
* _Note: as at the launch of this Application there are no bugs but this is not the finished product as I will be adding more features later on. If anyone comes in contact with a bug, be sure to hit me up on social media or email me @emzzyoluwole@gmail.com. WATCH OUT FOR VERSION 1.3.0 WHICH IS COMING SOON. Also in version 1.3.0, I would be making use of new tools like Async and Await function(from ES2017) and even a try....catch block just to show other ways an API call can be made_

* _P.S: two javaScript logic files where used here and there was a great separation of concern(logics) here too_

## WebLink
https://emzzy241.github.io/Weather-API-1.2.0/
